...
use app::image_compressor::compress_image;
use app::error::Error;
use app::huffman_coding::generate_huffman_table;
use app::huffman_coding::huffman_encode;
use app::huffman_coding::serilize_huffman_table;
use app::huffman_coding::deserilize_huffman_table;
use app::huffman_coding::huffman_decode;
